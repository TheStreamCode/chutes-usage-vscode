...
2. Run `pnpm install` if dependencies are not installed yet.
...
If you are editing both extension-host code and webview assets, run `pnpm run compile` again before reloading the Extension Development Host.
